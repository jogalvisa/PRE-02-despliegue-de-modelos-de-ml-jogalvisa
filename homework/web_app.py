...
def index():
    ...
    if request.method == "POST":
        ...
        user_values = {} #se crea un diccionario vacio para guardar los valores ingresados por el usuario
        ...
        df = pd.DataFrame.from_dict(user_values, orient="index").T #se convierte el diccionario en un dataframe de pandas
